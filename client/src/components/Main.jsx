            ...
            <div class=" w-full">
                <div style={{backgroundImage: `url(${newBg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: '700px', backgroundPosition: 'top'}}>
                    ...
                    <div class="p-4  m-auto rounded-2xl" style={{}}>
                        <h1 className="mainHeader rounded-2xl text-neutral-900 font-bold text-center h-min m-auto leading-none" style={{width: '70%', height: "80%"}}><span class="text-[#0B192C]">RELIVE</span><br/><span class="text-[#FF650E]">PAST MOMENTS</span></h1>
                        <h1 className="mainHeader rounded-2xl text-neutral-900 font-bold text-center h-min m-auto" style={{width: '75%'}}></h1>
                    </div>
                    <p className="hero_sub shadow-2xl text-[#1E3E62] bg-gray-100/70 p-4 rounded-2xl mt-4 m-auto font-bold text-2xl">
                        Save your old photos, share cherished memories with family and friends. We'll keep every memory for you.
                ...
                <div class="flex flex-col justify-center" style={{backgroundImage: `url(${newBg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: '700px', backgroundPosition: 'center'}}>
                    <div class="nil_container m-auto bg-gray-100/80 rounded-2xl w-2/3 h-2/3 shadow-2xl">
                        <div className="  p-8 flex flex-col md:flex-row justify-between mb-8">
                            <div className="w-full">
                                ...
                                <div className='option_container w-full flex flex-col md:flex-row flex-wrap justify-evenly items-center' >
                                    ...
                                    <div className="option_serv h-1/3 text-gray-800 bg-gray-200/70 mr-2 mb-8 bg-white shadow-2xl p-8 flex flex-col items-center justify-center">
                                        ...
                                        <p className="option_text font-bold italic text-center" style={{width: "200px"}}>Let us help you organize your files, or follow our expert guide.</p>
                                    </div>
                                    <div className="option_serv h-1/3 text-gray-800 bg-gray-200/70 mr-2 mb-8 bg-white shadow-2xl p-8 flex flex-col items-center justify-center">
                                        ...
                                        <p className="option_text font-bold italic text-center" style={{width: "200px"}}>Enhance your photos for better clarity, color, and visual appeal.</p>
                                    </div>
                                </div>
                ...
                <div className='overflow-y-scroll flex flex-wrap justify-evenly' style={{backgroundImage: `url(${newBg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: '700px', backgroundPosition: 'bottom'}}>
                    <div className="option_serv h-1/3 text-gray-800 bg-gray-200/70 shadow-2xl mr-2 mb-8  flex flex-col items-center justify-end">
                        <h3 className="text-4xl font-bold">SCAN</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" height="70px" viewBox="0 -960 960 960" width="70px" fill="#000000"><path d="M699.56-479.78 127.35-707.91l26.52-71.87 623.48 247.39q48.39 19.78 67.11 49.47 18.72 29.69 18.72 77.14V-220q0 32.51-23.53 55.86-23.52 23.36-56.26 23.36H176.61q-32.51 0-55.86-23.36Q97.39-187.49 97.39-220v-180q0-32.74 23.36-56.26 23.35-23.52 55.86-23.52h522.95ZM783.39-220v-180H176.61v180h606.78Zm-406.78-60h346.78v-60H376.61v60Zm-109.83 0q12.83 0 21.33-8.68 8.5-8.67 8.5-21.5 0-12.82-8.68-21.32-8.67-8.5-21.5-8.5-12.82 0-21.32 8.68-8.5 8.67-8.5 21.5 0 12.82 8.67 21.32 8.68 8.5 21.5 8.5Zm-90.17 60v-180 180Z"/></svg>
